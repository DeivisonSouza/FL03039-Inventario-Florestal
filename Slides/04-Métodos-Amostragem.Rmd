...
\normalsize
\begin{equation*}
V = \frac{\pi^2}{8.(20)}\left(2^2 + 2,4^2 + 3,3^2\right) = \textbf{1,2738}~\color{magenta}{m^3.ha^{-1}}
\end{equation*}
$$
...
\normalsize
\begin{equation*}
V = \frac{\pi^2}{8.(20)}\left(3,2^2 + 3,7^2\right) = \textbf{1,4761}~\color{magenta}{m^3.ha^{-1}}
\end{equation*}
$$
...
\normalsize
\begin{equation*}
V = \frac{\pi^2}{8.(20)}\left(11,3^2\right) = \textbf{7,8766}~\color{magenta}{m^3.ha^{-1}}
\end{equation*}
$$
