...
- 1) Qual a estimativa do volume (V) por hectare de necromassa para cada grau de decomposição?
- 2) Qual a estimativa da massa seca (W) por hectare de necromassa para cada grau de decomposição?
]
]
]
