...
.font80[
👉 Consite em dispor uma .blue[linha de tamanho L] pré-definido no .blue[piso florestal] e medir o .blue[diâmetro] de cada peça (resíduo) de material lenhoso .blue[interceptado] pela linha. Portanto, conhecidos os diâmetros das peças e o comprimento da linha é possível estimar o volume de material usando a fórmula:

$$
\small
\begin{equation*}
V = \frac{\pi^2 \left(\sum_{i=1}^{n}d_i^{2}\right)}{8L}
\end{equation*}
$$
...
$d_i$ = diâmetro da i-ésima peça no ponto de interseção (cm)
...
✔️ **2º Passo**: Registrar apenas o diâmetro de todas as peças (resíduos) no ponto de interseção com a linha;
