...
$FAB$ = Fator de Área Basal usado na amostragem de Bitterlich.
...
\small
\begin{equation*}
R_i = \frac{50d_i}{\sqrt{FAB}} = \frac{50(0,4599)}{\sqrt{2}} = 16,26~m ~ \color{green}{(Qualificada)}
\end{equation*}
$$
...
\small
\begin{equation*}
R_i = \frac{50d_i}{\sqrt{FAB}} = \frac{50(0,4615)}{\sqrt{2}} = 16,32~m ~ \color{red}{(Não~Qualificada)}
\end{equation*}
$$
...
\Large
\begin{equation*}
G = m.FAB = 9.(2) = 18~\color{magenta}{m².ha^{-1}}
\end{equation*}
$$
<br>
...
\normalsize
\begin{equation*}
N = \sum_{i=1}^{m}N_i = FAB\sum_{i=1}^{m}\left(\frac{1}{g_i}\right)
\end{equation*}
$$
<br>
