...
- $\bar{X}_{est}$ (lê-se: X-barra "est") = estimador da média aritmética populacional $\mu$ (lê-se: "mi") estratificada ou média amostral estratificada.
...
- $S_h^2$ (lê-se: S-quadrado "agá") = estimador da variância populacional $\sigma^2$ (lê-se: Sigma-quadrado) no estrato $h$ ou variância amostral no estrato $h$.
- $n_h$ = número de parcelas alocadas no estrato $h$.
- $X_{hi}$ = $i$-ésimo valor da variável $X$ nas unidades amostrais do estrato $h$.
...
- $S_h$ (lê-se: S "agá") = estimador do desvio padrão populacional $\sigma$ (lê-se: Sigma) no estrato $h$ ou desvio padrão amostral no estrato $h$.
- $n_h$ = número de parcelas alocadas no estrato $h$.
- $X_{hi}$ = $i$-ésimo valor da variável $X$ nas unidades amostrais do estrato $h$.
- $\bar{X_h}$ = estimativa da média aritmética populacional $\mu$ no estrato $h$.
]
...
- $S^2_{est}$ (lê-se: S-Quadrado "est") = estimador da variância populacional $\mu$ (lê-se: "mi") estratificada ou variância amostral estratificada.
- $W_h$ = Proporção do estrato $h$ na população florestal.
