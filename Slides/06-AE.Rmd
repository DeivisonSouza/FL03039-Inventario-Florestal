...
.font90[
👉 Estimar a média da variável de interesse $X$ nas unidades amostrais do estrato $h$.
...
- $\bar{X}_h$ (lê-se: X-barra "agá") = estimador da média aritmética populacional $\mu$ (lê-se: "mi") no estrato $h$ ou média amostral no estrato $h$.
