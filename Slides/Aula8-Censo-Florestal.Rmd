...
&nbsp;&nbsp;[1.9 - Unidade de Produção Anual - UPA](#upa)

&nbsp;&nbsp;[1.10 - Unidade de Trabalho - UT](#ut)

&nbsp;&nbsp;[1.11 - Plano Manejo Florestal Sustentável - PMFS](#pmfs)

&nbsp;&nbsp;[1.12 - Plano Operacional Anual - POA](#poa)

&nbsp;&nbsp;[1.13 - Autorização de Exploração - AUTEX](#autex)
...
7 - [Portaria MMA nº 443, de 17 de dezembro de 2014]() (Lista as espécies da flora brasileira ameaçadas de extinção)

8 - [Portaria MMA nº 148, de 07 de junho de 2022]() (Altera anexos da Portaria MMA nº 443, de 17 de dezembro de 2014)
...
.pull-right-3[
.pull-down[
`r anicon::faa("seedling", size = 5, speed = "slow", animate = 'vertical', color = "green")`
`r anicon::faa("leaf", size = 5, speed = "slow", animate = 'vertical', color = "green")`
