...
\begin{equation*}
\large
n = \dfrac{t^2\sum\limits_{h=1}^{L}W_h S^2_h}{E^2+t^2\sum\limits_{h=1}^{L}\dfrac{W_h S^2_h}{N}}
\end{equation*}
$$
...
$\bar{X}_{est}$ = Média Estratificada
...
| Estrato    | $N_h$   | $W_h$   | $S_h^2$ | $W_h$ $S_h^2$ | $\dfrac{W_h S^2_h}{N}$ |
|------------|:------:|:------:|:-----------:|:--------------:|:------------------:|
| Estrato I  | 650  | 0,65 | 71,538    | 46,500       | 0,046            |
| Estrato II | 350  | 0,35 | 261,174   | 91,411       | 0,091            |
| **Soma**       | **1000** | **1**    |           | **137,911**      | **0,138**            |
...
\large
n = \dfrac{t^2\sum\limits_{h=1}^{L}W_h S^2_h}{E^2+t^2\sum\limits_{h=1}^{L}\dfrac{W_h S^2_h}{N}} \\~\\ 
n = \dfrac{(2,069)^2~(137,911)}{(10,18)^2+(2,069)^2~(0,138)} \\~\\
n = 5,66 \approx 6~parcelas
\end{equation*}
$$
