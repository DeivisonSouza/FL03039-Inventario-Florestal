...
**2.** Para atender o objetivo geral a ser alcançado, que tipo de IF realizar?

**3.** Quais dados devem ser coletados?

**4.** Identificar e analisar as características da área a ser inventariada?

**5.** Em caso de IF amostral, qual a precisão requerida e sob qual probabilidade serão obtidas as estimativas dos parâmetros populacionais?

**6.** Em caso de IF amostral, quantas unidades de amostra serão necessárias para atender a precisão requerida?

**7.** Em caso de IF amostral, qual a forma e o tamanho das unidades de amostra que serão utilizadas?

**8.** Em caso de IF amostral, qual o processo de amostragem a ser adotado?
...
.font90[
- Identificar, mapear espécies e quantificar o .blue[volume de madeira] em floresta natural a ser manejada (Planos de Manejo);
]

--

.font90[
- Quantificar a .blue[produção volumétrica] de determinada espécie em um povoamento .blue[plantado] (Projetos de Desbastes);
]

--

.font90[
- Monitoramento da .blue[dinâmica, composição florística e estrutura] populacional de floresta natural (IFC - Parcelas Permanentes); e
]

--

.font90[
- Avaliar a .blue[composição florística, área basal, volume] de uma área para supressão de vegetação (Projetos de Supressão Florestal).
]
...
.font90[
- Inventário Florestal Amostral `r emo::ji("point_right")` Projetos de Desbaste, Projetos de Supressão da Vegetação (e outros)
]
