...
.pull-left-15[
.font90[
- A figura ilustra o parâmetro $\mu$ desconhecido e a construção de 100 ICs a partir de 100 amostras aleatórias (de mesmo tamanho n) tomadas de uma população.
- **O que espera-se?**: que 95% dos ICs construídos a partir das 100 amostras aleatórias da população contenham o verdadeiro valor de $\mu$ (**Que é desconhecido!**).
]
]

```{r echo = FALSE, out.width='68%', fig.align='center', fig.cap='', dpi=600}
