...
- **Resultado**: ter-se-á uma estimativa do parâmetro populacional $\mu$ (Ex.: $\bar{X} = 144~m^3.ha^{-1}$). Nesse caso, o valor de $\bar{X} = 144~m^3.ha^{-1}$ representa o valor mais plausível do parâmetro $\mu$ (baseado nos dados amostrais). Portanto, denomina-se esse valor de uma .blue[estimativa pontual de] $\color{blue}{\mu}$. **Essa estimativa depende da amostra!**
