...
$\large v_{p4} = 142~(m^3.ha^{-1})~~~~~~$
$\large v_{p7} = 146~(m^3.ha^{-1})$


- Obtendo-se a média, têm-se:

$\large \bar{v} = \dfrac{(142 + 146)}{2} = 144~(m^3.ha^{-1})$

- O quanto posso estar confiante de que a média amostral de $144~(m^3.ha^{-1})$ representa uma boa aproximação da média populacional?
]
]
