...
\begin{equation*}
\normalsize
N = \frac{1.000.000\color{orange}{m²}}{10.000\color{orange}{m²}} = \frac{100\color{blue}{ha}}{1\color{blue}{ha}} = 100~UA
\end{equation*}

<br><br>

.font90[
- **Interpretação**: É possível estabelecer 100 unidades amostrais de 1ha na população florestal de 100ha.
]
]
...
.pull-right-14[
```{r, echo=FALSE, out.width='75%', fig.align='center', dpi=600}
...
.font90[**Interpretação**: Foi amostrada uma fração de 5% da área total da população florestal. (**.orange[População é Finita!]**)]
