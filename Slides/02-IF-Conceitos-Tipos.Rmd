...
## ᨒ <br> `r anicon::faa("pagelines", animate="horizontal", colour="green")` Inventário Florestal `r anicon::faa("pagelines", animate="horizontal", colour="green")`
...
.font200[.yellow2[**Inventários Florestais: <br> Conceito, Importância e Tipos**]]
...
.shadow1[
## Conceito
É uma atividade que visa obter informações **qualitativas** e **quantitativas** dos **recursos florestais** existentes em uma **área pré-especificada** (PÉLLICO NETTO; BRENA, 1997), com o objetivo de bem administrá-los, seja através de seu uso racional, seja por meio de formulação de políticas públicas.
]
