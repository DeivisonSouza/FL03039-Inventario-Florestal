...
- Porém, ainda sim é importante obter uma estimativa da variância das médias amostrais. Isso pode ser feito pela fórmula:
...
- A estimativa da variância da média diminui à medida que o tamanho da amostra (n) é aumentado.
...
$$
- Na prática, $\color{blue}{S_\bar{X}^2}$ e $\color{blue}{S_\bar{X}}$ estimam a mesma coisa. Ou seja, a incerteza (variabilidade) da estimativa da média populacional. Mas, a diferença é que $\color{blue}{S_\bar{X}}$ é .blue[dado na mesma unidade de medida da variável de interesse]. Isso é mais conveniente!
...
- É o estimador do erro cometido devido realizar uma amostragem, ou seja, não medir toda a população.
