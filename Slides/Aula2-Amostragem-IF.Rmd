...
- É uma .blue[medida descritiva] (resumo) para uma variável de interesse da população.
- Na estatística, os parâmetros são representados por .blue[letras gregas].
...
.shadow1[
### Estimador
- É a estatística da amostra utilizada para estimar um parâmetro da população.
