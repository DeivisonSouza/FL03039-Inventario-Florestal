...
\begin{equation*}
S_h^2 = \frac{1}{n_{h} - 1}\sum_{i=1}^{n_h}\left (X_{hi} - \bar{X_h}  \right )^2 \\~\\
S_{h1}^2 = \frac{1}{12 - 1}(786,9167) = \textbf{71,54}~\color{magenta}{(m³.ha^{-1})^2}
\end{equation*}
$$
...
\begin{equation*}
S_h^2 = \frac{1}{n_{h} - 1}\sum_{i=1}^{n_h}\left (X_{hi} - \bar{X_h}  \right )^2 \\~\\
S_{h2}^2 = \frac{1}{12 - 1}(2.872,9167) = \textbf{261,17}~\color{magenta}{(m³.ha^{-1})^2}
\end{equation*}
$$
...
\bar{X}_{est} = 0,65.(89,08) + 0,35.(125,42) = \\~\\
...
- 4) Qual a estimativa de variabilidade da variável de interesse? (**Variância ou CV**)
